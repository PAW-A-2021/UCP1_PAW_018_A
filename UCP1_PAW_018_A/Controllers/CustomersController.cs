...
namespace UCP1_PAW_018_A.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer,NamaCustomer,MejaCustomer")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCustomer,NamaCustomer,MejaCustomer")] Customer customer)
        {
