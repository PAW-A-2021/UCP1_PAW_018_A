...
namespace UCP1_PAW_018_A.Controllers
{
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMenu,HargaMenu,JumlahMenu")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMenu,HargaMenu,JumlahMenu")] Menu menu)
        {
            if (id != menu.IdMenu)
            {
                return NotFound();
